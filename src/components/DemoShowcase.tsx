    ...
    <section id="demos" className="py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 mt-3">Real demo websites made for Dubai businesses</p>
        </div>
        ...
        <div className="text-center mt-10">
          <a
            href="https://wa.me/971501234567?text=Hi%20Vexyl!%20I%20want%20to%20see%20a%20demo%20for%20my%20business."
            target="_blank"
